...
public record AtualizarConsultaRequestDTO(
        ...
        @Schema(description = "Horário da consulta. Precisa estar preenchido.", example = "2025-12-31T15:30:00")
    ...
    public AtualizarConsultaInputModel toInputModel(UUID id) {

        return new AtualizarConsultaInputModel(
                id,
                medicoId,
                horario,
                pacienteId,
